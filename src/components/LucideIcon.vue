...
const ICONS: Record<string, string> = {
  ...
  'list-checks':   '<path d="M11 6H3"/><path d="M11 12H3"/><path d="M11 18H3"/><polyline points="15 12 17 14 21 10"/>',
...
const iconPath = computed(() => ICONS[props.name] ?? `<circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>`)
</script>
